...
exports.getValidationService = getValidationService;
const StepService_1 = require("./StepService");
class ValidationService {
    async validateScenario(scenario) {
        ...
        const stepService = (0, StepService_1.getStepService)();
    ...
    checkForAmbiguities(scenario, cachedSteps, issues) {
        if (!cachedSteps) {
            return;
        }
        for (const step of scenario.steps) {
