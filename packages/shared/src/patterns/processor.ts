...
import type { PatternSegment, FormattedPattern } from '@suisui/step-regex'
import {
  tableHandler,
  enumHandler,
  cucumberHandler,
...
// stripAnchors and patternToRegex now live in @suisui/step-regex; re-export
// them so existing `@suisui/shared` consumers keep working unchanged.
export { stripAnchors, patternToRegex } from '@suisui/step-regex'
