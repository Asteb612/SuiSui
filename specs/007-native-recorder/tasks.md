...
- [ ] T042 [US3] Extend `recorder-adapter.js`: classify sensitive fields during the fingerprint `page.evaluate` and **omit** the value (`secret:true`) before it leaves the child.
